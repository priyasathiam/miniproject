...
<html>
<head>
<title>ONLINE HEALTH SHOPPING...!</title>
...
<body>
    ...
    <div class="main">
       ...
       <!-- NAVIGATION BAR STARTS HERE --> 
        <div class="menubar">
            <ul id="menu">
                <li><a href="/Online_health_Shopping/index.php">HOME</a></li>
                <li><a href="/Online_health_Shopping/all_products.php">ALL PRODUCTS</a></li>
                <li><a href="/Online_health_Shopping/customer/my_account.php">MY ACCOUNTS</a></li>
                <li><a href="/Online_health_Shopping/customer_register.php">SIGN UP</a></li>
                <li><a href="/Online_health_Shopping/cart.php">SHOPPING CART</a></li>
			            ...
			            <div id="sidebar">
			                <div id="sidebar_title">My Account</div>
			                    ...
			                    <ul id="cats">
			                       ...
			                       <li><a href="/Online_health_Shopping/cart.php">My Orders</a></li>
     ...
     <!-- CONTENTS SECTION ENDS HERE -->
         ...
         <div id="footer">
                          <h2 style="text-align: center;padding-top: 10px ">&copy rights 2021</h2>
         </div>
